...
sudo apt install -y \
    ...
    ubuntu-restricted-extras libfuse2t64 p7zip-full glslang-tools vulkan-tools util-linux util-linux-extra google-android-platform-tools-installer >/dev/null 2>&1
